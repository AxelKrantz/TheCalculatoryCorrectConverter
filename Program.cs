...
menu[2] = new string[] { "Back", "Meter", "Foot", "cm", "inches","miles" };
menu[3] = new string[] { "Back", "cl", "dl", "l" , "Cup", };

double[][] conversion = new double[3][];

conversion[0] = new double[] { 8.68, 0.088, 1, 11.83, 6.83, 0.12};
conversion[1] = new double[] { 1, 0.3048, 0.01, .0254, 1608};
conversion[2] = new double[] { 1, 10, 100, 23.66};
